...
Premium AI web app for plant leaf disease identification + agronomy assistant (Vision Transformer inference + DeepSeek chat guidance). Educational decision‑support only (not a certified diagnostic tool).
